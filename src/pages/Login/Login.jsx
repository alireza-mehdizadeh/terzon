            ...
            <div className='login-box-wrapper'>

                {
                    loginErr && (
                        <Modal onHide={hideLoginErr}>
                            ...
                            <Link className='warn-modal-link' to='/register'>ساخت حساب</Link>
                        </Modal>
                    )
                }
                ...
                <div className="login-box">
                    ...
                    <div className="body">
                        ...
                        <input onChange={userEmailHandler} value={userEmail} placeholder='ایمیل خود را وارد کنید...' id='login-email-input' type="email" />

                        <label htmlFor="login-pass-input">پسورد شما:</label>
                        <input onChange={userPassHandler} value={userPassword} placeholder='پسورد خود را وارد کنید...' id='login-pass-input' type="password" />

                        <button disabled={isLoading} style={{ opacity: isLoading && '70%' }} onClick={loginHandler}>{isLoading ? 'درحال ورود...' : 'ورود به حساب'}</button>
                        <span>هنوز حسابی ندارید؟ <Link to='/register'>اینجا کلیک کنید.</Link></span>
                    </div>
                </div>
            </div>
            <Footer />
